...
| [0011](0011-auth-multitenancy-rbac.md) | Auth, multitenancy & RBAC | Accepted | Local email/password = identity only (HS256 session JWT, scrypt; updated from Cognito 2026-06-18); memberships+roles in Postgres; pool tenancy with RLS; `org_id` propagates into Temporal run context. |
